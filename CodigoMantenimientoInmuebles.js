...
for (let i = 1; i <= 10; i++) {
  ...
  <td id="nivelR${i}" class="input_tabla fijasCol" aria-label="Nivel/Area/Otro"></td>
    ...
    <td>
     ...
     <td>
          <input type="number"
                 name="numeroServiciosR${i}"
                 class="input_tabla"
                 aria-label="numeroServicios">
     </td>
...
document.getElementById("tablaBody").addEventListener("change", e => {
  if (!e.target.name?.startsWith("nombredelBienR")) return;
...
try {
    const res = await fetch("https://script.google.com/macros/s/AKfycbwB0LCst3AWQ0Mny-rIRrlE1dy_ybJe6q-H1b8PycymZSEWpoEVxxydgdigQC_L3mIb/exec", {
      method: "POST",
 ...
 const aviso = document.getElementById("aviso");   
    document.getElementById("miFormulario").addEventListener("submit", function(e){
                ...
                /*fetch("https://script.google.com/macros/s/AKfycbylJPoK0gXZxnMQzAWlCLGbwMvi7OsMV-rKF3eEpNDSkpbzZ8R6kzFAadKFIonA97Of-Q/exec", {
                 ...
                 fetch("https://script.google.com/macros/s/AKfycbwB0LCst3AWQ0Mny-rIRrlE1dy_ybJe6q-H1b8PycymZSEWpoEVxxydgdigQC_L3mIb/exec", {
                  method: "POST",
